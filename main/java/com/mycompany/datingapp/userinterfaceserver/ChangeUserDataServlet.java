...
public class ChangeUserDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        InvitationServiceInterface inviteService = (InvitationServiceInterface) context.getAttribute("iService");
        request.setAttribute("userData", userDataService.getByUser(user));
        request.setAttribute("invites", inviteService.getAllInvitesToUser(user));
